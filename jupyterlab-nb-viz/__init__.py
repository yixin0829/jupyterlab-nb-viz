...
def _jupyter_server_extension_points():
    return [{"module": "jupyterlab-nb-viz"}]
...
def _load_jupyter_server_extension(server_app):
    ...
    """
    print('Loading jupyterlab-nb-viz server extension')
    ...
    route_pattern = url_path_join(
        web_app.settings["base_url"], "jupyterlab-nb-viz", "api", "files"
    )
    web_app.add_handlers(host_pattern, [(route_pattern, RouteHandler)])
    server_app.log.info(
