...
function Legend() {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButton, { className: "mb-3", color: "warning", onClick: () => setVisible(!visible), "aria-expanded": visible, "aria-controls": "collapseWidthExample" }, "Show legend"),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: { minHeight: '120px' } },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCollapse, { id: "collapseWidthExample", horizontal: true, visible: visible },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCard, { style: legendCardStyle },
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCardBody, { style: { backgroundColor: '#E1E1E1', opacity: '0.8', padding: '10px', width: "300px" } },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", null,
                                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: legendItemStyle },
                                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: legendNodeStyle },
                                        ...
                                        "x/y",
                                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: redStyle }, "----")),
                                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: legendLongText }, "Recommendation edge: this column combination appears in y notebooks for x times."))))))))));
}
...
const PlotNode = ({ data }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2___default().get(`http://127.0.0.1:4000/plot/${data.methodId}`, { responseType: 'blob', withCredentials: true })
            .then((response) => {
...
/* harmony import */ var _TreeUtils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./TreeUtils */ "./lib/TreeUtils.js");
...
/* harmony import */ var _Legend__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Legend */ "./lib/Legend.js");
/* harmony import */ var _RecommendEdge__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./RecommendEdge */ "./lib/RecommendEdge.js");
...
/* harmony import */ var _DownloadButton__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./DownloadButton */ "./lib/DownloadButton.js");
...
const edgeTypes = {
    recommended: _RecommendEdge__WEBPACK_IMPORTED_MODULE_16__["default"],
};
const FlowComponent = (props) => {
    ...
    const collapseBackToInitial = () => {
        // collapse the tree to initial state
        const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('CollapseBackToInitial', null, nodes, edges, allNodes, allEdges, edgeOperations.current);
        setNodes(newNodes);
        setEdges(newEdges);
    };
    ...
    const handleNodeClick = (event, node) => {
        ...
        if ((node.data.nodeType !== 'plot') && (node.data.nodeType !== 'insight')) {
            ...
            if (node.data.nodeType === 'etc') {
                const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('ExpandEtcNode', node, nodes, edges, allNodes, allEdges, edgeOperations.current);
                setNodes(newNodes);
                setEdges(newEdges);
                return;
            }
    ...
    const handleEdgeClick = (event, edge) => {
        ...
        setIsSelectedEdgeRemovable((0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.isEdgeRemoveable)(edge, nodes, edges));
        console.log(`[handleEdgeClick] selectedEdge: ${JSON.stringify(edge)}`);
    };
    const handleExpandAllChildrenButtonClick = () => {
        if (selectedNode && canExpandAll) {
            const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('ExpandSubtree', selectedNode, nodes, edges, allNodes, allEdges, edgeOperations.current);
            setNodes(newNodes);
            setEdges(newEdges);
            setCanExpandAll(false);
        }
    ...
    const handleCollapseAllButtonClick = () => {
        if (selectedNode && canCollapseAll) {
            const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('CollapseSubtree', selectedNode, nodes, edges, allNodes, allEdges, edgeOperations.current);
            setNodes(newNodes);
            setEdges(newEdges);
            setCanCollapseAll(false);
        }
    ...
    const handleCollapseNonTopButtonClick = () => {
        if (selectedNode && canCollapseNonTop) {
            const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('CollapseNonTop', selectedNode, nodes, edges, allNodes, allEdges, edgeOperations.current);
            setNodes(newNodes);
            setEdges(newEdges);
            setCanCollapseNonTop(false);
        }
    ...
    const handleExpandAllNodesButtonClick = () => {
        const { nodes: newNodes, edges: newEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('ExpandAllNodes', null, nodes, edges, allNodes, allEdges, edgeOperations.current);
        setNodes(newNodes);
        setEdges(newEdges);
    };
    const resetNodeStyles = () => {
    ...
    const refreshSMITree = () => {
        ...
        (0,react_promise_tracker__WEBPACK_IMPORTED_MODULE_7__.trackPromise)(axios__WEBPACK_IMPORTED_MODULE_6___default().post('http://127.0.0.1:4000/tracking-tree', request, { withCredentials: true, }).then((response) => {
            ...
            const { nodes: layoutedNodes, edges: layoutedEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.translateTreeUtilCommand)('GetInitial', null, null, null, refreshedNodes, refreshedEdges, edgeOperations.current);
    ...
    const getRecommendations = () => {
        ...
        (0,react_promise_tracker__WEBPACK_IMPORTED_MODULE_7__.trackPromise)(axios__WEBPACK_IMPORTED_MODULE_6___default().post('http://127.0.0.1:4000/recommendations', request, { withCredentials: true }).then((response) => {
            ...
            const { nodes: layoutedNodes, edges: layoutedEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.getLayoutedElements)(newNodes, newEdges);
            setNodes(layoutedNodes);
            setEdges(layoutedEdges);
    ...
    const removeSelectedEdge = () => {
        ...
        if (selectedEdge && isSelectedEdgeRemovable) {
            const { nodes: layoutedNodes, edges: layoutedEdges } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.removeEdge)(selectedEdge, nodes, edges);
    ...
    const onConnect = (connection) => {
        ...
        if (!(0,_TreeUtils__WEBPACK_IMPORTED_MODULE_17__.isEdgeConnectable)(connection, nodes)) {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(reactflow__WEBPACK_IMPORTED_MODULE_5__.Panel, { position: "top-center", style: { width: "100%" } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: pageTopContainerStyle },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { flex: "1" } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Legend__WEBPACK_IMPORTED_MODULE_18__.Legend, null)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { flex: "1" } },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_DownloadButton__WEBPACK_IMPORTED_MODULE_19__.DownloadButton, null)),
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: buttonContainerStyle },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { ...buttonGroupWithBorderSytle, minWidth: "250px" } },
                        (!isRecommendationDisplayed) && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_10__.CButton, { color: "warning", style: dropdownButtonStyle, onClick: getRecommendations }, "Show recommendations"),
                        (isRecommendationDisplayed) && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_10__.CButton, { color: "warning", style: dropdownButtonStyle, onClick: disableRecommendations, disabled: !isRecommendationDisplayed }, "Hide recommendations")),
...
//# sourceMappingURL=lib_index_js.904acd1c1efe0daa5d0d.js.map