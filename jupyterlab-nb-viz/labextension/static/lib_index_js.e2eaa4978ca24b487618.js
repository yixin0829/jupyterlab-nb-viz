...
const FlowComponent = (props) => {
    ...
    const datasetId = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)("");
    ...
    const handleNodeClick = (event, node) => {
        ...
        if (collapsibleNodeTypes.includes(node.data.nodeType)) {
            ...
            if (node.data.label.endsWith('(+)')) {
                const { nodes: newNodes, } = (0,_TreeUtils__WEBPACK_IMPORTED_MODULE_16__.translateTreeUtilCommand)('ExpandSubtree', selectedNode, nodes, edges, allNodes, edgeOperations.current);
                setNodes(newNodes);
                setEdges((0,_TreeUtils__WEBPACK_IMPORTED_MODULE_16__.createEdgesBasedOnNodes)(newNodes));
                return;
            }
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: pageTopContainerStyle },
                ...
                isRecommendNodeSelected &&
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { flex: "1" } },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_RecommendationCodeSnippets__WEBPACK_IMPORTED_MODULE_18__.RecommendationCodeSnippets, { variableCombination: selectedRecommendedPath, datasetId: datasetId.current })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: buttonContainerStyle },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { ...buttonGroupWithBorderSytle } },
                        (!isRecommendationDisplayed) && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_10__.CButton, { color: "danger", style: { ...recommendationButtonStyle, color: "white" }, onClick: getRecommendations }, "Show recommendations"),
...
/* harmony import */ var react_promise_tracker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-promise-tracker */ "webpack/sharing/consume/default/react-promise-tracker/react-promise-tracker");
...
/* harmony import */ var clipboard_copy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! clipboard-copy */ "webpack/sharing/consume/default/clipboard-copy/clipboard-copy");
...
/* harmony import */ var _coreui_icons_react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @coreui/icons-react */ "webpack/sharing/consume/default/@coreui/icons-react/@coreui/icons-react");
/* harmony import */ var _coreui_icons_react__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_coreui_icons_react__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _coreui_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @coreui/icons */ "webpack/sharing/consume/default/@coreui/icons/@coreui/icons");
/* harmony import */ var _coreui_icons__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_coreui_icons__WEBPACK_IMPORTED_MODULE_8__);
...
const CodeHighlight = ({ language, code }) => {
    ...
    const copyCodeToClipboard = () => {
        if (code) {
            clipboard_copy__WEBPACK_IMPORTED_MODULE_6___default()(code);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("pre", null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("code", { dangerouslySetInnerHTML: { __html: highlightedCode } })),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("button", { style: copyButtonStyle, onClick: copyCodeToClipboard },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement((_coreui_icons_react__WEBPACK_IMPORTED_MODULE_7___default()), { icon: _coreui_icons__WEBPACK_IMPORTED_MODULE_8__.cilCopy, size: "xl", title: "Copy code" }))));
};
function RecommendationCodeSnippets({ variableCombination, datasetId }) {
    const [visible, setVisible] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const [currentPage, setCurrentPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0);
    const [showEquivalentColumns, setShowEquivalentColumns] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
    ...
    const [srcNbAndCodeList, setSrcNbAndCodeList] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([defaultSrcNbAndCode,]);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const fetchDataFromBackend = async () => {
            try {
                ...
                const response = await axios__WEBPACK_IMPORTED_MODULE_4___default().post(apiUrl, request, { withCredentials: true, });
        ...
        (0,react_promise_tracker__WEBPACK_IMPORTED_MODULE_5__.trackPromise)(fetchDataFromBackend());
    }, [variableCombination]);
    ...
    if (promiseInProgress) {
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButton, { className: "mb-3", color: "warning", disabled: true, "aria-controls": "collapseCodeSnippets", style: showButtonStyle }, "Please wait for fetching code snippets from backend...")));
    }
    else {
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCollapse, { id: "collapseCodeSnippets", horizontal: true, visible: visible },
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCard, { style: cardStyle },
                        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCardBody, { style: cardBodyStyle },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: variableCombinationDivStyle },
                                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: centeredTextSpanStyle }, "Code snipptes for column combination:"),
                                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: boldTextSpanStyle },
                                    " ",
                                    printList(variableCombination))),
                            (showEquivalentColumns) &&
                                (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: variableCombinationDivStyle },
                                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: centeredTextSpanStyle }, "Corresponding columns in the code snippet:"),
                                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: boldTextSpanStyle },
                                        " ",
                                        printList(getEquivalentColumnList()),
                                        " "))),
                            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: centeredTextDivStyle },
                                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null,
                                    "Source Notebook: ",
                                    getSourceNotebook(),
                                    ".ipynb"))))))));
...
function expandEtcNode(selectedNode, curNodes, allNodesBackend) {
    ...
    const queue = childrenNotInCurNodes;
    const subtreeNodes = [];
    ...
    while (queue.length > 0) {
        ...
        const curNodeChildren = curNodeChildrenId.map((id) => getNodeById(id, allNodesBackend));
        curNodeChildren.forEach((child) => { queue.push(child); });
    }
...
function collapseBackEtcNode(selectedNode, curNodes, allNodes, etcThreshold = 3) {
    ...
    const nonTopChildrenSubtreeNodes = [];
    const queue = nonTopChildren;
    while (queue.length > 0) {
        const currentNode = queue.shift();
        nonTopChildrenSubtreeNodes.push(currentNode);
        const children = currentNode.data.children.map((id) => getNodeById(id, allNodes));
        children.forEach((child) => { queue.push(child); });
    }
    const newNodesAfterRemoveNonTop = curNodes.filter((n) => !nonTopChildrenSubtreeNodes.some((c) => c.id === n.id));
    const etcNode = createEtcNode(selectedNode, etcThreshold);
...
function collapseTreeBackToInitial(allNodesBackend, etcThreshold = 3) {
...
//# sourceMappingURL=lib_index_js.e2eaa4978ca24b487618.js.map